...
setwd("C:\\Users\\alison.stern\\Documents\\Kohls\\FO Enhancements\\R Code\\3 R Functions_08.24.2016\\Data Merging")
...
big_master_data<-big_master_data[c("Store","Climate","VSG","Product","Space","Sales","Units","Profit","Exit_Flag","Future_Space","Entry_Space","BOH $","BOH Units","CC Count w/ BOH","Profit %","Receipts  $","Receipts Units")]
