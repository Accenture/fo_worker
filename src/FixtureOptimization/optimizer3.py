...
def optimize3(methodology,jobName,Stores,Categories,tierCounts,increment,weights,cfbsOutput,preOpt,salesPen):
    ...
    def createErrorByLevel(Stores, Categories, Levels, mergedCurveFitting):
        ...
        print(mergedCurveFitting.columns)
    ...
    print('right before methodology')
    ...
    if jobName[0:4] == 'flag':
        fractGap = int(jobName[4:9])

    NewOptim.solve(pulp.PULP_CBC_CMD(msg=2, threads=4, fracGap=fractGap))
